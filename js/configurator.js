(function () {
  ...
  function handle(action) {
    ...
    else if (action.startsWith('remove-')) { state.sets.splice(Number(action.split('-')[1]), 1); if (state.sets.length <= 1) state.cartMode = 'loose'; }
    else return;
    render();
  }
